...
;----------------------------------------------------------------------
	...
	TEXT_COLS = 32
		...
		sw		at,$0000(a0)
		addiu	a0,a0,$04
		li		at,$60000000		; black rect（改为纯黑）
		sw		at,$0000(a0)
		addiu	a0,a0,$04
		li		at,$00000000
		sw		at,$0000(a0)
...
; NES button     A      B     SEL   START UP    DOWN  LEFT  RIGHT  TurboA TurboB
padMasks	dh	$4000,$8000,$0001,$0008,$0010,$0040,$0080,$0020,$1000,$2000
; PSX button     X     Sqr   SEL   START UP    DOWN  LEFT  RIGHT  Tri   Cir
...
copy2		db "                                "
copy3		db "     It Might Be NES v1.3.5     "
...
btnCfgTurboA db "  Press Turbo A...              "
btnCfgTurboB db "  Press Turbo B...              "
